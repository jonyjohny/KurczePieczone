                ...
                <div class="flex justify-end pt-2">
                    <div class="px-2">
                        <x-button dark label="{{ __('translations.actions.back') }}"
                            href="{{ route('breeding.index') }}?&filters[active-filter]=0" />
                    </div>
                    <div class="px-2">
                        <x-button primary label="{{ __('translations.actions.create') }}"
                            href="{{ route('breedingplaces.create', [$breeding]) }}" />
                    </div>
                    <div class="px-2">
                        <x-button green label="{{ __('translations.actions.report') }}"
                            href="{{ route('breedingreport.report', [$breeding]) }}" />
                    </div>
                </div>
                <div style="overflow-x: auto;">
                    <livewire:breedingplaces.breedingplaces-table-view />
                </div>
            </div>
        </div>
    </div>
