...
class RestoreIncubationreportAction extends Action
{
    public $title = '';
    ...
    {
        $view->dialog()->confirm([
            'title' => __('incubationreport.dialogs.restore.title'),
            'description' => __('incubationreport.dialogs.restore.description', [
                'name' => $model->name,
            ]),
            'icon' => 'question',
