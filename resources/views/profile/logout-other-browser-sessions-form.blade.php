<x-jet-action-section>
    <x-slot name="title">
        {{ __('profiles.BrowserSessions') }}
    </x-slot>

    <x-slot name="description">
        {{ __('profiles.BrowserSessionsInfo') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('profiles.BrowserSessionsInfoAdd') }}
        </div>
                        ...
                        <div class="ml-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @else
                                        {{ __('profiles.Lastactive') }} {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
